...
<body>
	...
	<div class="alert alert-info">
		...
		<strong>Bienvenidos</strong><br/>  <font face="comic sans">En Dito Online, ofrecemos los servicios de comercio electrónico.
...
Para simplificar el proceso de pedido, debe registrarse en el siguiente formulario.</font></div>
	 <div class="alert alert-block alert-error fade in">
		...
		<strong>  Es importante recordar que:</strong><br/> <font face="comic sans">Por favor, rellene los datos para el nombre, la dirección y el contacto puede contactarse forma más completa posible para que podamos procesar envíos.</font>
