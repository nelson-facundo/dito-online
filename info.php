    ...
    <li id="gallery" class="span3">
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <p>
                    <b>$<?php echo format_angka($barangData['harga_jual']); ?></b>
                </p>

                <h4 style="text-align:center"><a class="btn" href="?open=Barang-Lihat&Kode=<?php echo $KodeBarang; ?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Añadir <i class="icon-shopping-cart"></i></a> </h4>
            </div> 
