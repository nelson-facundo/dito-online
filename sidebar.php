...
<div id="sidebar" class="span3">
		<div class="well well-small">Categorias de la tienda</div>
...
$mySql = "SELECT * FROM kategori ORDER BY nm_kategori";
		  $myQry = mysql_query($mySql, $koneksidb) or die ("Query : ".mysql_error());
...
?>
		...
		<ul>	
			...
			<div class="caption ">
			  ...
			  <h4><a class="btn btn-large" href="?open=Barang-Lihat&Kode=<?php echo $KodeProduk; ?>">Ver Artículo</a> <span class="pull-right">$<?php echo format_angka($precio); ?></span></h4>
